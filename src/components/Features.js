...
const Features = () => {
  return (
    <section className="features">
      ...
      <div className="box">
        <i class="fa fa-building box__icon" aria-hidden="true"></i>
      ...
      <div className="box">
        <i class="fa fa-cutlery box__icon" aria-hidden="true"></i>
        <h4 className="box__header">Free Meals</h4>
        <p className="box__paragraph">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Explicabo veritatis amet illum ab culpa pariatur nemo eum maiores ullam veniam?</p>
      </div>

      <div className="box">
        <i class="fa fa-bicycle box__icon" aria-hidden="true"></i>
